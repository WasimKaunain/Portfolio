...
export default function ExperienceSection() {
	...
	function openMail(e: React.FormEvent) {
		e.preventDefault();
		const to = "wasimkonain@gmail.com";
		const subject = encodeURIComponent(`Portfolio message from ${cName || "Someone"}`);
				...
				>
					<div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
						<div>
							...
							<div className="mt-2 text-xs text-zinc-500 font-mono">Current role</div>
						</div>
						<div className="max-w-2xl">
							<p className="text-sm text-zinc-300 leading-relaxed">
