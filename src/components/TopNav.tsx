  ...
  return (
    <div className="fixed top-4 left-0 right-0 z-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between gap-4 rounded-2xl border border-white/10 bg-black/35 backdrop-blur-xl px-4 py-3 shadow-2xl">
          <a
            data-gravity-item="1"
            href="#home"
            className="font-mono text-xs text-zinc-300 hover:text-white transition"
          >
            wasim.dev
          </a>
            ...
            {links.map((l) => {
              ...
              return (
                <a
                  ...
                  className={`relative rounded-xl px-3 py-2 text-xs transition border ${
                    isActive
